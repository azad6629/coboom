...
class Config(object):
    def __init__(self):
        ...
        self.num_hiddens = 128  #hidden layer channels
        self.num_residual_hiddens = 64
        self.num_residual_layers = 5
        self.embedding_dim = 256   #The dimensionality of each codeword vector
        self.num_embeddings = 4096   #The number of codewords in the codebook.
...
class Encoder(nn.Module):
    def __init__(self, in_channels, num_hiddens, num_residual_layers, num_residual_hiddens):
        ...
        self._residual_stack = ResidualStack(in_channels=num_hiddens*2,  #128
                                             num_hiddens=num_hiddens*2,  #128
                                             num_residual_layers=num_residual_layers,  #5
...
class Model(nn.Module):
    def __init__(self, num_hiddens, num_residual_layers, num_residual_hiddens, 
        ...
        self._pre_vq_conv = nn.Conv2d(in_channels=num_hiddens*2, 
