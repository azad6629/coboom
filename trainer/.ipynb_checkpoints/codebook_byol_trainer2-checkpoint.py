...
from model import BYOLModel_CB2
...
#         self.vae_ckpt_path = '/workspace/mayankk/Radiomics/BERT-BYOL/trainer/vq_vae_v1_NIH_100_final.pth'
    ...
    def construct_model(self):
        ...
        params = params_util.collect_params([self.model.online_network, self.model.online_codebook,
                                             self.vae_projection],
...
#         return loss
    ...
    def train_epoch(self, epoch):
        ...
        p1_meter = eval_util.AverageMeter()
        p2_meter = eval_util.AverageMeter()
        ...
        while images is not None:
            ...
            # forward
            cbl1, q1, p1, e1,cbl2, q2, p2, e2,target_z1,target_z2 = self.model(view1, view2, self.mm)
...
#             print(q1.shape,target_z1.shape,embd.shape)
...
#             loss6 = self.forward_loss(target_z2, embd)
            ...
            p1_meter.update(p1.item(), view1.size(0))
            p2_meter.update(p2.item(), view1.size(0))
            ...
            if self.steps % self.log_step == 0:
                self.logger.info(f'Epoch: [{epoch}][{i}/{len(self.train_loader)}]--'
                                ...
                                f'Per {p1_meter.val:.2f} ({p2_meter.val:.2f})--' 
                                f'CBL {cbl1_meter.val:.2f} ({cbl2_meter.val:.2f})--' 
