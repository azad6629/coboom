...
from .v2_vq_vae_nih import model as vae
...
class BYOLTrainer():
    def __init__(self, config):
        ...
        self.vae_ckpt_path = '/workspace/mayankk/Radiomics/BERT-BYOL/trainer/vq_vae_v2_NIH_100_best.pth'
        self.vae = vae
    ...
    def construct_model(self):
        ...
        params = params_util.collect_params([self.model.online_network, self.model.predictor,
                                             self.model.target_network.projetion,self.vae_projection],
