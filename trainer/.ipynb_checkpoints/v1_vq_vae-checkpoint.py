...
class Config(object):
    def __init__(self):
        ...
        self.num_residual_layers = 3
        self.embedding_dim = 128   #The dimensionality of each codeword vector
        self.num_embeddings = 1024   #The number of codewords in the codebook.
